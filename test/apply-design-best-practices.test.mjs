...
// The apply-design-best-practices skill is a curated routing table: each topic
...
test("is exposed under the apply-first public identity", () => {
  assert.match(text, /^name: lazyweb-apply-design-best-practices$/m);
  assert.match(text, /fetch the #1 pick's instruction file/i);
